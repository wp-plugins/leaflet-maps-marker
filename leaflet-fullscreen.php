...
if (isset($_GET['layer'])) {
	...
	if ($panel == 1) {
		...
		$lmm_out .= '<span style="' . addslashes($lmm_options[ 'defaults_layer_panel_paneltext_css' ]) . '">' . $paneltext . '</span><span style="float:right;width:105px;text-align:right;">';
...
elseif (isset($_GET['marker'])) {
	...
	if ($panel == 1) {
		...
		$lmm_out .= '<span style="' . addslashes($lmm_options[ 'defaults_marker_panel_paneltext_css' ]) . '">' . $paneltext . '</span><span style="float:right;width:105px;text-align:right;">';
