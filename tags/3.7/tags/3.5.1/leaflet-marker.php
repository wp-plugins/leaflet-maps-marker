		...
		<table class="widefat fixed">
			...
			<tr>
				<td><label for="default_icon"><strong><?php _e('Icon', 'lmm') ?></strong></label>
					...
					if (is_multisite()) {					
					$mapicons_directory = sprintf( __('As you are running your blog within a WordPress Multisite installation, please use this icon directory on your server: %2$s/','lmm'), '<a tabindex="114" href="http://mapicons.nicolasmollet.com" target="_blank">Map Icons Collection</a>', $defaults_marker_icon_url); 
