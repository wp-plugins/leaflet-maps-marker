...
if (!lmm_is_plugin_active('leaflet-maps-marker/leaflet-maps-marker.php') ) {
	...
	if ($lmm_options[ 'wms_wms_kml_support' ] == 'yes') { $wms_kml_output = '<NetworkLink id="mapsmarker_wms1"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms2_kml_support' ] == 'yes') { $wms2_kml_output = '<NetworkLink id="mapsmarker_wms2"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms2_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms2_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms2_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms2_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms2_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms2_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms2_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms2_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms3_kml_support' ] == 'yes') { $wms3_kml_output = '<NetworkLink id="mapsmarker_wms3"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms3_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms3_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms3_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms3_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms3_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms3_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms3_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms3_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms4_kml_support' ] == 'yes') { $wms4_kml_output = '<NetworkLink id="mapsmarker_wms4"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms4_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms4_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms4_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms4_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms4_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms4_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms4_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms4_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms5_kml_support' ] == 'yes') { $wms5_kml_output = '<NetworkLink id="mapsmarker_wms5"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms5_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms5_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms5_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms5_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms5_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms5_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms5_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms5_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms6_kml_support' ] == 'yes') { $wms6_kml_output = '<NetworkLink id="mapsmarker_wms6"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms6_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms6_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms6_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms6_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms6_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms6_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms6_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms6_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms7_kml_support' ] == 'yes') { $wms7_kml_output = '<NetworkLink id="mapsmarker_wms7"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms7_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms7_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms7_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms7_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms7_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms7_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms7_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms7_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms8_kml_support' ] == 'yes') { $wms8_kml_output = '<NetworkLink id="mapsmarker_wms8"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms8_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms8_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms8_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms8_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms8_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms8_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms8_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms8_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms9_kml_support' ] == 'yes') { $wms9_kml_output = '<NetworkLink id="mapsmarker_wms9"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms9_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms9_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms9_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms9_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms9_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms9_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms9_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms9_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
	if ($lmm_options[ 'wms_wms10_kml_support' ] == 'yes') { $wms10_kml_output = '<NetworkLink id="mapsmarker_wms10"><name><![CDATA[' . wp_kses($lmm_options[ 'wms_wms10_name' ]) . ']]></name><visibility>1</visibility><open>0</open><atom:author><![CDATA[' . wp_kses($lmm_options[ 'wms_wms10_attribution' ]) . ']]></atom:author><Snippet maxLines="2"><![CDATA[' . wp_kses($lmm_options[ 'wms_wms10_attribution' ]) . ']]></Snippet><Link><href><![CDATA[' . htmlspecialchars($lmm_options[ 'wms_wms10_kml_href' ]) . ']]></href><refreshMode>' . $lmm_options[ 'wms_wms10_kml_refreshMode' ] . '</refreshMode><refreshInterval>' . intval($lmm_options[ 'wms_wms10_kml_refreshInterval' ]) . '</refreshInterval><viewRefreshMode>' . $lmm_options[ 'wms_wms10_kml_viewRefreshMode' ] . '</viewRefreshMode><viewRefreshTime>' . intval($lmm_options[ 'wms_wms10_kml_viewRefreshTime' ]) . '</viewRefreshTime></Link></NetworkLink>'; };
