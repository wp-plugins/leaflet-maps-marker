		...
		<table class="widefat fixed">
			...
			<tr>
				...
				<td id="wmscheckboxes">
					...
					echo '<span style="' . addslashes($lmm_options[ 'defaults_layer_panel_paneltext_css' ]) . ';">' . (($name == NULL) ? __('if set, layername will be inserted here','lmm') : stripslashes($name)) . '</span><span style="float:right;width:105px;text-align:right;">';
						...
						echo '<a href="' . LEAFLET_PLUGIN_URL . '/leaflet-georss.php?layer=' . $id . '" style="text-decoration:none;" title="' . __('Export as GeoRSS','lmm') . '" target="_blank"><img src="' . LEAFLET_PLUGIN_URL . '/img/icon-georss.png" width="14" height="14" alt="GeoRSS-Logo" style="background:no-repeat;margin:0px;padding:0px;" /></a>&nbsp;';
						}
