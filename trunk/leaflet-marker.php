		...
		<table class="widefat fixed">
			...
			<tr>
				...
				<td id="wmscheckboxes">
					...
					echo '<span style="' . addslashes($lmm_options[ 'defaults_marker_panel_paneltext_css' ]) . ';">' . (($markername == NULL) ? __('if set, markername will be inserted here','lmm') : stripslashes($markername)) . '</span><span style="float:right;width:105px;text-align:right;">';
						...
						echo '<a href="' . LEAFLET_PLUGIN_URL . '/leaflet-georss.php?marker=' . $id . '" style="text-decoration:none;" title="' . __('Export as GeoRSS','lmm') . '" target="_blank"><img src="' . LEAFLET_PLUGIN_URL . '/img/icon-georss.png" width="14" height="14" alt="GeoRSS-Logo" style="background:no-repeat;margin:0px;padding:0px;" /></a>&nbsp;';
						}
